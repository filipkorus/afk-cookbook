...
const RecipeWallCard: React.FC<RecipeWallCardProps> = ({recipe}) => {
	...
	return <Box m={2}>
		<Card>
			...
			/>
			<CardContent>
				<Typography fontFamily="Monospace" variant="h5" mb={2}>
				...
				<Box my={2}>
					<RouterLink to={`/recipe/${recipe.id}`}>
						<Button variant="outlined" style={{color:theme.palette.primary.main, borderColor:theme.palette.primary.main}} size="small" fullWidth>See full recipe</Button>
					</RouterLink>
				</Box>
			</CardContent>
